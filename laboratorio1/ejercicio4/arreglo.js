...
-	https://drive.google.com/file/d/1RZsCpXzBOEUbQqSFtrGe31yzM_A4J-gg/view?usp=sharing , este archivo tiene un arreglo de películas en forma de objetos, copie el arreglo a un archivo propio de JS, recorra el arreglo y retorne en una función solo las películas en idioma inglés (“en”).
*/
...
for (let i = 0; i < peliculas.length; i++) {
    if (idioma !== peliculas[i].original_language) {
